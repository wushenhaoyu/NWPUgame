import {
    ...
    Tween, UITransform, Vec3, EventMouse, EventTouch, EventKeyboard, input, Input
} from 'cc';
...
export default class Player extends Component {
    ...
    onDestroy() {
        ...
        // add mouse input listener to jump left and righ
        input.off(Input.EventType.MOUSE_MOVE, this.onMouseDown, this);
